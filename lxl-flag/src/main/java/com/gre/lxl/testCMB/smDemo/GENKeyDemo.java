 ...
 * 
 * @Package: CMB_SM
 * @Description: 直联上传密钥生成样例，仅供参考，用户私钥请妥善保管，用户公钥以及加密后用户对称密钥在网银上上传， 用户对称密钥为16长度字符串，用户可自己随机生成，saas厂商针对不同用户请使用不同密钥串，如有疑问请联系对接人员。
 * @author: CMB
 * @date: 2022年3月2日 下午5:06:19
 * @version v1.0
 * @inspector:
 * @inspectdate:
 */
public class GENKeyDemo {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // System.out.println("解密后用户对称密钥: " + new String(CMBSM2Decrypt(privatekey, Base64.getDecoder().decode(sm2EnKey))));
        } catch (Exception e) {
