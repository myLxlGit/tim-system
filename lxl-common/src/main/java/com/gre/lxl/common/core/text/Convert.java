package com.gre.lxl.common.core.text;
...
public class Convert {
    ...
    public static Boolean toBool(Object value, Boolean defaultValue) {
        ...
        List<String> trueString = Lists.newArrayList("true", "ok", "yes", "1");
        List<String> falseString = Lists.newArrayList("false", "no", "0", "1");
        if (trueString.contains(valueStr)) {
            return true;
        }
        if (falseString.contains(valueStr)) {
            return false;
        }
        return defaultValue;
    }
